...
public class ClientThread implements Runnable{
    ...
    public void run(){
        ...
        System.out.println("Client id" + numberClient + " is online.");
        try {
            new PrintWriter(clientSocket.getOutputStream(), true).println("Client id" + numberClient + ".");
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        ...
        while (true){
            ...
            if (!"exit".equals(clientMessage)){
                System.out.println("Client id" + numberClient + ": " + clientMessage);
